...
function eternal_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'eternal_custom_background_args',
			array(
...
function eternal_scripts() {
	wp_enqueue_style( 'eternal-style', get_stylesheet_uri(), array(), time() );
	//wp_enqueue_style('eternal-main', get_template_directory_uri() . '/style.css', array(), _S_VERSION);


	wp_enqueue_script( 'eternal-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
